...
let mask32 start stop = mask64 (start + 32) (stop + 32)
...
let rlwinm arch ~sh ~from ~to_ ctxt =
  ...
  let x = Word.of_int64 0xAABBCCDDL in
...
let rlwimi arch ~sh ~from ~to_ ctxt =
  ...
  let x = Word.of_int64 0xAABBCCDDL in
  let y = Word.of_int64 0xAABBCCDD_FFEEAA42L in
  let r9 = find_gpr "R9" in
  let r10 = find_gpr "R10" in
  let init = Bil.[
      r9  := int x;
...
let suite = "rotate" >::: [
    ...
    "rldicl sh:4 from:25"       >:: rldicl `ppc ~sh:4 ~from:25;
    "rldicl sh:4 from:55"       >:: rldicl `ppc ~sh:4 ~from:55;
    "rldicl sh:4 from:0"        >:: rldicl `ppc ~sh:4 ~from:0;
    "rldicl sh:0 from:25"       >:: rldicl `ppc ~sh:0 ~from:25;
    "rldicl sh:0 from:0"        >:: rldicl `ppc ~sh:0 ~from:0;

    "rldicr sh:4 to:25"         >:: rldicr `ppc ~sh:4 ~to_:25;
    "rldicr sh:4 to:55"         >:: rldicr `ppc ~sh:4 ~to_:55;
    "rldicr sh:4 to:0"          >:: rldicr `ppc ~sh:4 ~to_:0;
    "rldicr sh:0 to:25"         >:: rldicr `ppc ~sh:0 ~to_:25;
    "rldicr sh:0 to:0"          >:: rldicr `ppc ~sh:0 ~to_:0;

    "rldic sh:4 from:25"        >:: rldic `ppc ~sh:4 ~from:25;
    "rldic sh:4 from:55"        >:: rldic `ppc ~sh:4 ~from:55;
    "rldic sh:4 from:0"         >:: rldic `ppc ~sh:4 ~from:0;
    "rldic sh:0 from:25"        >:: rldic `ppc ~sh:0 ~from:25;
    "rldic sh:0 from:0"         >:: rldic `ppc ~sh:0 ~from:0;

    "rldcl sh:4 from:25"        >:: rldcl `ppc ~sh:4 ~from:25;
    "rldcl sh:4 from:55"        >:: rldcl `ppc ~sh:4 ~from:55;
    "rldcl sh:4 from:0"         >:: rldcl `ppc ~sh:4 ~from:0;
    "rldcl sh:0 from:25"        >:: rldcl `ppc ~sh:0 ~from:25;
    "rldcl sh:0 from:0"         >:: rldcl `ppc ~sh:0 ~from:0;

    "rldcr sh:4 to:25"          >:: rldcr `ppc ~sh:4 ~to_:25;
    "rldcr sh:4 to:55"          >:: rldcr `ppc ~sh:4 ~to_:55;
    "rldcr sh:4 to:0"           >:: rldcr `ppc ~sh:4 ~to_:0;
    "rldcr sh:0 to:25"          >:: rldcr `ppc ~sh:0 ~to_:25;
    "rldcr sh:0 to:0"           >:: rldcr `ppc ~sh:0 ~to_:0;

    "rldimi sh:4 from:25"       >:: rldimi `ppc ~sh:4 ~from:25;
    "rldimi sh:4 from:55"       >:: rldimi `ppc ~sh:4 ~from:55;
